...
### 2. 행동 이력 수집 함수 호출
```javascript
// Groobee 스크립트가 로드되면 해당 값을 자동으로 가져가기 때문에 스크립트가 로드되기 전에 선언되어 있어야합니다.
<script type="text/javascript">
...
<script type="text/javascript">
    (function(a,i,u,e,o) {
        a[u]=a[u]||function(){(a[u].q=a[u].q||[]).push(arguments)};
        a[u].q = a[u].q || [];
        a[u].start = a[u].start || function () {
            a[u].q.push(["start"]);
        };
        a[u].action = a[u].action || function () {
            a[u].q.push(["action"].concat([].slice.call(arguments)));
        };
    })(window, document, "groobee");
...
<script type="text/javascript">
    window.groobee.action("행동코드", {/*행동에 맞는 데이터*/});
</script>
```
