...
**서비스 도메인을 Groobee 어드민 사이트에 등록해야 합니다.**
...
3. 서비스를 사용할 **사이트 도메인**을 입력합니다.

![도메인 설정](../images/prerequisites/web-domain-setting.png)
...
- 하이브리드 앱의 경우에도 앱의 웹뷰(혹은 웹킷)에서 스크립트가 사용되므로 도메인을 등록해줘야 합니다.
